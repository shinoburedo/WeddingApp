...
namespace MauloaDemo.Reports {
    ...
    /// </summary>
    public partial class VendorConfirmation_Datail_DLV : GrapeCity.ActiveReports.SectionReport
    {
        private List<VendorConfirmationReport> mInfo;

        public VendorConfirmation_Datail_DLV(List<VendorConfirmationReport> info, string dateFormat, string timeFormat)
        {
            //
            ...
            txtdelivery_date.OutputFormat = dateFormat;
            txtdelivery_time.OutputFormat = timeFormat;
