...
namespace MauloaDemo.Reports {
    ...
    /// </summary>
    public partial class VendorConfirmation_Datail_MKS : GrapeCity.ActiveReports.SectionReport
    {
        private List<VendorConfirmationReport> mInfo;

        public VendorConfirmation_Datail_MKS(List<VendorConfirmationReport> info, string dateFormat, string timeFormat)
        {
            //
            ...
            txtmake_date.OutputFormat = dateFormat;
            txtmake_in_time.OutputFormat = timeFormat;
