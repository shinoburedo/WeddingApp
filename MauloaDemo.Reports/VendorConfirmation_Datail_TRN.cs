...
namespace MauloaDemo.Reports {
    ...
    /// </summary>
    public partial class VendorConfirmation_Datail_TRN : GrapeCity.ActiveReports.SectionReport
    {
        private List<VendorConfirmationReport> mInfo;

        public VendorConfirmation_Datail_TRN(List<VendorConfirmationReport> info, string dateFormat, string timeFormat)
        {
            //
            ...
            txtpickup_date.OutputFormat = dateFormat;
            txtpickup_time.OutputFormat = timeFormat;
