...
namespace MauloaDemo.Reports {
    ...
    /// </summary>
    public partial class VendorConfirmation_Datail_SHT : GrapeCity.ActiveReports.SectionReport
    {
        private List<VendorConfirmationReport> mInfo;

        public VendorConfirmation_Datail_SHT(List<VendorConfirmationReport> info, string dateFormat, string timeFormat)
        {
            //
            ...
            txtshoot_date.OutputFormat = dateFormat;
            txtshoot_time.OutputFormat = timeFormat;
